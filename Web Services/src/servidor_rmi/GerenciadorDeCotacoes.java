...
public class GerenciadorDeCotacoes {
    ...
    public GerenciadorDeCotacoes(Map<InterfaceCli, Usuario> mapaDeUsuarios) {
    ...
    private void notificarUsuario(String codigoDaAcao, Float novoValor, Usuario usuario,
        ...
        try {
            usuario.getReferenciaCliente().notificar(msg);
            msg = "Servidor: usuario notificado de limite de " + tipo + ": " + usuario.getNome();
            System.out.println(msg);
        } catch (RemoteException e) {
            msg = "Servidor: erro ao notificar usuario de limite de " + tipo + ": " + usuario.getNome();
            System.out.println(msg);
            e.printStackTrace();
        }
    }
